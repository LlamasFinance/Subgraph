...
export class Activate extends Entity {
  constructor(id: string) {
    ...
    this.set("countId", Value.fromBigInt(BigInt.zero()));
  ...
  get countId(): BigInt {
    let value = this.get("countId");
    return value!.toBigInt();
  }

  set countId(value: BigInt) {
    this.set("countId", Value.fromBigInt(value));
  }
...
export class Received extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type Received must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
